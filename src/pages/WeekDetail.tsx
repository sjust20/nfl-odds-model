...
export function atBookLine(p: Prediction, bookLine: number | null, bookTotal: number | null): Prediction {
  return {
    ...p,
...
/** Every game this week with all model numbers, plus last week's results (the pre-redesign table). */
